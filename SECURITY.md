...
Please report vulnerabilities by opening a **Draft Security Advisory** on this repository or emailing `security@yourdomain.com` (replace with your actual contact).
...
* **Token Management:** Use `spark::sql::SparkSession::Builder::token()` carefully. Never hardcode authentication tokens in your C++ source code (See examples on **Databricks Authentication**).
