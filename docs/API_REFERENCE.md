...
auto df_stats = df.describe({"age", "weight", "height"}).show();
```
...
+----------------------+----------------------+----------------------+----------------------+----------------------+
| count                | 3                    | 3                    | 3                    | 3                    |
| mean                 | null                 | 12.0                 | 40.73333             | 145.00000            |
| stddev               | null                 | 1.0                  | 3.1722757341273704   | 4.763402145525822    |
