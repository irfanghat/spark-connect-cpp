...
static DataType from_proto_internal(const spark::connect::DataType& proto)
{
    ...
    if (proto.has_array())
    {
        ArrayType arr;
        arr.element_type =
            std::make_shared<DataType>(from_proto_internal(proto.array().element_type()));
...
struct JsonVisitor
{
    std::string operator()(const NullType&) const
    {
        return "\"void\"";
    }
    std::string operator()(const BooleanType&) const
    {
        return "\"boolean\"";
    }
    std::string operator()(const ByteType&) const
    {
        return "\"byte\"";
    }
    std::string operator()(const ShortType&) const
    {
        return "\"short\"";
    }
    std::string operator()(const IntegerType&) const
    {
        return "\"integer\"";
    }
    std::string operator()(const LongType&) const
    {
        return "\"long\"";
    }
    ...
    std::string operator()(const DoubleType&) const
    {
        return "\"double\"";
    }
    ...
    std::string operator()(const BinaryType&) const
    {
        return "\"binary\"";
    }
    std::string operator()(const DateType&) const
    {
        return "\"date\"";
    }
    ...
    std::string operator()(const TimestampNtzType&) const
    {
...
struct TypeNameVisitor
{
    ...
    std::string operator()(const DecimalType&) const
    {
        return "decimal";
    }
    std::string operator()(const CharType&) const
    {
        return "char";
    }
    std::string operator()(const VarCharType&) const
    {
        return "varchar";
    }
    ...
    std::string operator()(const MapType&) const
    {
        return "map";
    }
...
{
    return std::visit(TypeNameVisitor{}, kind);
}
